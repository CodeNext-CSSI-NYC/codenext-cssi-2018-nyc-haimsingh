...
// function firstTime(array, num) {
// 	let times = 0
// 	for (times = 0; times < array.length; times++) {
// 		array[times]
// 		if (array[times] != num) {
//
// 		} else {
...
// 	console.log(times);
// }
// // If your functtimeson is correct, these should both print true.
...
// // console.log(inWords("star\r") == true);
// // console.log(inWords("starrrrr\r") == false);
//
// // console.log(words);
//
...
// // 	let arr = [];
// // 	for (var i = 0; i < words.length; i++) {
// // 		if (words[i].charAt(0) == letter && words[i].charAt(words[i].length - 2) == letter) {
// // 			arr.push(words[i]);
// // 		}
// // 	}
// // 	return arr;
...
// // console.log(startAndEndWith("y").includes("yearly\r"));
// // console.log(startAndEndWith("w").length == 7);
// // console.log(startAndEndWith("w").includes("workflow\r"));
//
//
//
...
// onto that array, so the
// return value should be the array[0, 1, 1, 2, 3]
...
// 	coinType = Object.keys(coins);
// 	console.log(coinType);
// 	let money = 0;
// 	for (var i = 0; i < coinType.length; i++) {
// 		if (coinType[i] == "quarters") {
// 			money = money + (.25 * coins["quarters"]);
// 			console.log(money);
// 		} else if (coinType[i] == "dimes") {
// 			money = money + (.1 * coins["dimes"]);
// 			console.log(money);
// 		} else if (coinType[i] == "nickels") {
// 			money = money + (.05 * coins["nickels"]);
// 			console.log(money);
// 		} else if (coinType[i] == "pennies") {
// 			money = money + (.01 * coins["pennies"]);
// 		}
// 		console.log(money);
// 	}
// 	return money;
...
// function waitFor24() {
// 	let guess = parseInt(readline.question("Guess 24- "));
// 	while (guess != 24) {
// 		guess = parseInt(readline.question("Guess 24- "));
// 	}
// }
