...
//   attempt = readline.question("Enter your password ")
// //   counter++
// // }
// // console.log("It toom you " + counter + " attempts");
...
// let sum = 0;
// while (sum != 100) {
//   let add = parseInt(readline.question("What shall I add? "));
//   sum += add;
//   console.log(sum);
// }
// console.log("You reached 100");
