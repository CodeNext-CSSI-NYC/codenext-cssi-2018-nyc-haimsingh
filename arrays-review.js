...
// console.log(fiveNum[fiveNum.length - 2]);
...
// let myMiiChar = ["Beth", "James", "Jackson", "Nikki", "Tyrone"]
// console.log(myMiiChar[0]);
// console.log(myMiiChar[1]);
// console.log(myMiiChar[2]);
// console.log(myMiiChar[3]);
// console.log(myMiiChar[4]);
//
...
// plum
// // PLUM
// let food = ["apple", "orange", "pear", "plum"]
...
// let question = parseInt(readline.question("How mant times shall I loop? "));
// let arr = [];
// for (var i = 0; i < question; i++) {
//   let letter = readline.question("Enter a char. ")
//   arr.push(letter);
// }
